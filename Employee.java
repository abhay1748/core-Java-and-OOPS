...
public class Employee { // extends Object {
    ...
    // In a One class we can have multiple constructor and it beocme constructor
    // overloading.
     ...
     * " basic salary "+salary+" Company Name "+companyName);
     * }
     */
    ...
    public String toString() {
        ...
        String allowances = "Hra " + formatting.format(hra()) + " DA " + formatting.format(da()) + " TA  "
                + formatting.format(ta()) + " MA " + formatting.format(ma()) + " PF " + formatting.format(pf())
                + "\n GS " + formatting.format(gs()) + "\nTAX " + formatting.format(tax()) + "\n NS "
                + formatting.format(ns());
        return "Employee [Date is " + formatting.dateFormat(date) + "\n\n id=" + id + ", name="
                + formatting.getTitleCase(name) + ", salary=" + salary + ", companyName=" + companyName + "\n " +
    ...
    // @Override
    // public String toString(){
    // return "Id "+id +" Name "+name+" Basic Salary"+salary+" Company Name
    // "+companyName;
    // }
}