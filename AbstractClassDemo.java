...
// If i am a child class and i wouldn't override the abstract methods so my
// class
...
public class AbstractClassDemo {
    public static void main(String[] args) {
        ...
        // Loan loan = new Loan() ; // Loan is a Generic class/Entity, so we can't
        // identify which kind of loan this is ?
