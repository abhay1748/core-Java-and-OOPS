public class StringDemo {
     ...
     * b) new Object --> It create one object in a pool if not exist and another one
     * outside the pool
     */
    public static void main(String[] args) {
        ...
        String name5 = new String("Amit").intern();// intern checks in the pool if string exists if yes then itpoints
                                                   // that one only . no need to create new object
